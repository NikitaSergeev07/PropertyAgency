...
const { onClose } = withDefaults(defineProps<{
    onClose?: any;
}>(), {
    onClose: () => ({}),
});
...
const { createProperty, createAddress } = usePropertyStore();
...
const createNewAddress = async () => {
    ...
    try {
        ...
        console.log('[PropertyCreateModal/createNewAddress]: ', e);
        return {};
    }
};
...
const onSubmit = async () => {
    ...
    try {
        ...
        console.log('[PropertyCreateModal/onSubmit]: ', e);
    }
};
</script>
